...
/*
Jordan's notes
. changing any setting (through settings .ini) caused jerkiness
. rbutton interfered with workflow, mostly with other gesture program, resize window script
. mbutton might prove difficult muscularly
. ideally would have its own button (xbutton2?) on a mouse with more buttons.
. ! recently saw horizontal scrolling not working.  need to repro with original script.
.   30 Mar 2013: fixed by using wheelmessage (not scrollmessage)
